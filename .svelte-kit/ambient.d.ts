...
declare module '$env/static/private' {
	...
	export const WERKZEUG_SERVER_FD: string;
	export const npm_config_engine_strict: string;
	export const WSL_DISTRO_NAME: string;
	export const SERENA_CONFIG_PATH: string;
	export const COLOR: string;
	export const NVM_DIR: string;
	export const WAYLAND_DISPLAY: string;
	export const LOGNAME: string;
	export const SERENA_PROJECT_ROOT: string;
	...
	export const SERENA_WEB_DASHBOARD: string;
	export const SHELL: string;
	export const npm_package_version: string;
	export const npm_lifecycle_event: string;
	export const PYENV_VIRTUALENV_DISABLE_PROMPT: string;
	export const SERENA_LOG_LEVEL: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		VISUAL: string;
		WERKZEUG_SERVER_FD: string;
		npm_config_engine_strict: string;
		WSL_DISTRO_NAME: string;
		SERENA_CONFIG_PATH: string;
		COLOR: string;
		NVM_DIR: string;
		WAYLAND_DISPLAY: string;
		LOGNAME: string;
		SERENA_PROJECT_ROOT: string;
		PULSE_SERVER: string;
		WSL_INTEROP: string;
		NAME: string;
		...
		SERENA_WEB_DASHBOARD: string;
		SHELL: string;
		npm_package_version: string;
		npm_lifecycle_event: string;
		PYENV_VIRTUALENV_DISABLE_PROMPT: string;
		SERENA_LOG_LEVEL: string;
		SAVEHIST: string;
		POSH_THEME: string;
