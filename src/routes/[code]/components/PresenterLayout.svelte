<script lang="ts">
  ...
  interface PresenterLayoutProps {
    ...
    sessionCode: string;
    qrSection?: Snippet<[{ store: SimpleSessionStore; sessionCode: string }]>;
    statsSection?: Snippet<[{ store: SimpleSessionStore }]>;
    analyticsSection?: Snippet<[{ store: SimpleSessionStore }]>;
    insightsSection?: Snippet<[{ store: SimpleSessionStore }]>;
  }
...
>
  ...
  <section class="presenter-section bg-white">
    <div
      ...
      in:slide={{ direction: 'up', duration: 1000, easing: quintOut }}
    >
      {#if statsSection}
  ...
  <section class="presenter-section bg-white">
    <div
      class="max-w-6xl mx-auto"
      in:slide={{ direction: 'up', duration: 1000, delay: 200, easing: quintOut }}
    >
      {#if insightsSection}
