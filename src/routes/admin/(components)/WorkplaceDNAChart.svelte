...
<div class="dna-profile-card {className}">
	...
	<!-- Insights -->
	<div
		class="mt-6 p-4 rounded-xl bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200"
	>
		<div class="flex items-start gap-3">
			<span class="text-2xl">💡</span>
			<div>
				<p class="text-sm font-semibold text-purple-700 mb-1">Key Insight</p>
