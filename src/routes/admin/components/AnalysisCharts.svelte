<script lang="ts">
	...
	import D3DonutChart from "$lib/components/charts/D3DonutChart.svelte";
	...
	import { createDonutData, createRadarData, chartColors } from "$lib/utils/chart-config";
      ...
      {#snippet children()}
        <div class="chart-container">
          {#if generationDonutData()}
            <D3DonutChart data={generationDonutData()} />
          {:else}
