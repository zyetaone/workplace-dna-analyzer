<script lang="ts">
  ...
  import type { getSessionStore } from '../admin/admin.svelte.ts';
  ...
  const stats = $derived(() => {
    ...
    const completed = analytics().completedCount;
    const active = analytics().activeCount;
    const completionRate = analytics().responseRate;
...
<div class="live-stats-section">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <!-- Active Participants -->
    <div
      class="stats-card card-hover-lift bg-gradient-to-br from-green-50 to-green-100 border-green-200"
    ...
    <!-- Completed Quizzes -->
    <div
      class="stats-card card-hover-lift bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200"
    ...
    <!-- Completion Rate -->
    <div
      class="stats-card card-hover-lift bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200"
  ...
  >
    ...
    <div class="mb-6">
      <div class="flex justify-between items-center mb-2">
        ...
        <span class="text-sm text-gray-500">{stats().completionRate}%</span>
      </div>
