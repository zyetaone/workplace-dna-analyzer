<script lang="ts">
	...
	const gradients = {
		...
		vibrant:
			'linear-gradient(135deg, #0f0f23 0%, #1e3a8a 25%, #7c3aed 50%, #c026d3 75%, #1a1a2e 100%)'
	};
...
>
	...
	<div class="absolute inset-0 pointer-events-none">
		...
		<div
			class="absolute top-0 left-0 w-96 h-96 rounded-full blur-3xl {variant === 'default'
				? 'bg-blue-500/20'
				: variant === 'subtle'
					? 'bg-blue-600/15'
					: 'bg-blue-700/25'}"
		...
		<div
			class="absolute bottom-0 right-0 w-96 h-96 rounded-full blur-3xl {variant === 'default'
				? 'bg-purple-500/20'
				: variant === 'subtle'
					? 'bg-indigo-600/15'
					: 'bg-purple-700/25'}"
		...
		<div
			class="absolute top-1/4 right-1/3 w-80 h-80 rounded-full blur-3xl opacity-20 animate-floatOrb bg-gradient-to-r {variant ===
			'default'
				? 'from-cyan-900/20 to-violet-900/20'
				: variant === 'subtle'
					? 'from-cyan-800/15 to-violet-800/15'
					: 'from-cyan-700/25 to-violet-700/25'}"
		></div>

		<div
			class="absolute bottom-1/3 left-1/4 w-72 h-72 rounded-full blur-3xl opacity-15 animate-floatOrb bg-gradient-to-r {variant ===
			'default'
				? 'from-indigo-900/15 to-pink-900/15'
				: variant === 'subtle'
					? 'from-indigo-800/10 to-pink-800/10'
					: 'from-indigo-700/20 to-pink-700/20'}"
