...
// Helper schema for session slugs only
export const SessionSlugSchema = v.pipe(v.string(), v.regex(/^[a-z0-9][a-z0-9-]*[a-z0-9]$/), v.maxLength(100));
...
export type SessionSlug = v.InferInput<typeof SessionSlugSchema>;
